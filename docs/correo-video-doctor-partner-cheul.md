# Correo — video doctor partner (Cheul habla, Toloza graba)

Brief para grabar el video en el que Jorge Cheul explica cómo ser **doctor
partner** de Clinera. Borrador en Gmail de Ricardo; este archivo lo deja
versionado.

- **Para:** `jorge.cheul@oacg.cl`, `mauricio.toloza@oacg.cl`
- **Asunto:** Video doctor partner: Cheul explica el convenio — Toloza graba

Términos canónicos: `src/content/partners-program.ts` (`PARTNERS_DOCTORS_CONVENIO`)
y `src/content/convenio-doctores-page.ts`. Landing: `/convenio-doctores`.

---

Cheul, Toloza,

Necesitamos un video corto (1–2 min) donde **Jorge Cheul** explique cómo ser
**doctor partner** de Clinera.

- Cheul: cara y voz.
- Toloza: producción / grabación.

## Referencia (de acá sale el guion)

Landing del convenio — úsenla para saber qué decir, en este orden:

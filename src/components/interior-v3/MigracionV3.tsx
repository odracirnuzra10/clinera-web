      ...
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        ...
        >
          ...
          >
            ...
            >
              + USD 450 configuración inicial (pago único) · con el primer mes del plan
            </p>
          </div>
        </div>
      </div>

  ...
  return (
    <>
      ...
      <a
        ...
        aria-label="Solicita asistencia por WhatsApp"
      >
        <svg viewBox="0 0 32 32" fill="#fff" width="22" height="22" style={{ flexShrink: 0 }}>
        ...
        <span className={styles.waFloatText}>Solicita asistencia</span>
      </a>

  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text:
          "Aplica permanentemente a todas las cuentas activas que la agencia traiga: Vortex, Atlas o Summit. Sin tope, sin vencimiento. Se descuenta directo del precio del plan que paga la clínica.",
      },
    },
    {
      "@type": "Question",
